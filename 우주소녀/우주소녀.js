...
function control_song_information() {
  album_information_button.classList.remove(
    "selected_button_backgroundColor_WJSN"
  );
  song_information_button.classList.add("selected_button_backgroundColor_WJSN");
...
function control_lyrics() {
  lyrics_control_button.title === "가사 더 보기"
    ? ((lyrics_control_button.title = "가사 접기"),
      (lyrics_control_button.ariaLabel = "가사 접기"))
    : ((lyrics_control_button.title = "가사 더 보기"),
      (lyrics_control_button.ariaLabel = "가사 더 보기"));
